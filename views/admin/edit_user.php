...
<head>
    ...
    <title>Edytuj Użytkownika - mBochnia</title>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control readonly-field" value="<?php echo htmlspecialchars($formData['pesel']); ?>"
                           readonly style="background-color: #e9ecef;">
                    <small class="form-text text-muted">PESEL nie może być zmieniony.</small>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="data_urodzenia"
                           value="<?php echo htmlspecialchars($formData['data_urodzenia']); ?>" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Minimalnie 6 znaków</small>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
...
<script>
    ...
    document.querySelector('input[name="haslo"]').addEventListener('input', function(e) {
        const password = e.target.value;
        if (password.length > 0 && password.length < 6) {
            e.target.setCustomValidity('Hasło musi mieć co najmniej 6 znaków');
        } else {
