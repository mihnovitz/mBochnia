...
<div class="container my-5">
    <div class="hero-section">
        ...
        <div class="logo">
            ...
            <?php if ($is_logged_in): ?>
                <div class="welcome-message">
                    Witaj, <?php echo isset($_SESSION['user_name']) ? $_SESSION['user_name'] : 'Użytkowniku'; ?>!
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="text-center">
            <img src="rynek_bochnia.jpg" alt="Rynek w Bochni" class="main-image">
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <p>
                    ...
                    potrzeby wszystkich mieszkańców. W mBochni znajdziesz m.in.:
                </p>
                <ul class="feature-list">
                    ...
                    <li><strong>Ogłoszenia i alerty</strong> – bądź na bieżąco z wszystkim, co dzieje się w Twoim mieście.</li>
                    <li><strong>Zgłaszanie spraw</strong> – poinformuj urząd o awarii lub problemie w przestrzeni miejskiej. Dzięki geolokalizacji jest to niezwykle proste.</li>
                </ul>
                ...
                <!-- Sekcja logowania/dashbordu -->
                <div class="login-section">
                    <?php if ($is_logged_in): ?>
                        <h4>Jesteś zalogowany!</h4>
                        <p>Przejdź do panelu użytkownika aby zarządzać swoimi kartami</p>
                        <div>
                            <a href="documents.php" class="btn btn-dashboard">Przejdź do panelu</a>
                            <a href="logout.php" class="btn btn-logout">Wyloguj się</a>
                        </div>
                    <?php else: ?>
                        <h4>Masz już konto?</h4>
                        <p>Zaloguj się aby uzyskać dostęp do wszystkich funkcji</p>
                        <div>
                            <a href="login.php" class="btn btn-login">Zaloguj się</a>
                            <a href="register.php" class="btn btn-register">Zarejestruj się</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
